...
class PhoneBookManager
{
	...
	HashSet<PhoneInfo> infoStrorage = new HashSet<PhoneInfo>();
	...
	public void inputData() throws MenuChoiceException
	{
		...
		boolean isAdded = infoStrorage.add(info);
	...
	{
		Iterator<PhoneInfo> itr = infoStrorage.iterator();
